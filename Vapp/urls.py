...
from .views import (
    ...
    ,check_registration,EventGalleryAPIView,EventBadgesAPIView,AwardBadgeAPIView
)
...
urlpatterns = [
    ...
    path('api/events/<uuid:E_ID>/check-registration/', check_registration, name='check-registration'),
    ...
    path('events/<uuid:E_ID>/gallery/', EventGalleryAPIView.as_view(), name='event-gallery'),
    path('events/<uuid:E_ID>/badges/', EventBadgesAPIView.as_view(), name='event-badges'),
    path('events/<uuid:E_ID>/badges/<uuid:badge_id>/award/', AwardBadgeAPIView.as_view(), name='award-badge'),
