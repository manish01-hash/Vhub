...
function MyEvents() {
    ...
    async function fetchNotifications() {
        try {
            const response = await axios.get("https://vhub-zb2y.onrender.com/api/notifications/", {
                headers: { Authorization: `Bearer ${localStorage.getItem("accessToken")}` },
            });
    ...
    async function markAllAsRead() {
        try {
            await axios.patch("https://vhub-zb2y.onrender.com/api/notifications/mark-all-read/", {}, {
                headers: { Authorization: `Bearer ${localStorage.getItem("accessToken")}` },
            });
            setNotifications([]);
        } catch (error) {
